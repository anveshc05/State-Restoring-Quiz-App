...
class CricketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cricket" do
    assert_difference('Cricket.count') do
      post crickets_url, params: { cricket: { correctans: @cricket.correctans, opta: @cricket.opta, optb: @cricket.optb, optc: @cricket.optc, optd: @cricket.optd, question: @cricket.question } }
    end
  ...
  test "should update cricket" do
    patch cricket_url(@cricket), params: { cricket: { correctans: @cricket.correctans, opta: @cricket.opta, optb: @cricket.optb, optc: @cricket.optc, optd: @cricket.optd, question: @cricket.question } }
