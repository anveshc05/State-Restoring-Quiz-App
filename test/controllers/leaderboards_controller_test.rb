...
class LeaderboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leaderboard" do
    assert_difference('Leaderboard.count') do
      post leaderboards_url, params: { leaderboard: { bollywoodscore: @leaderboard.bollywoodscore, cricketscore: @leaderboard.cricketscore, footballscore: @leaderboard.footballscore, hollywoodscore: @leaderboard.hollywoodscore, user_id: @leaderboard.user_id } }
    end
  ...
  test "should update leaderboard" do
    patch leaderboard_url(@leaderboard), params: { leaderboard: { bollywoodscore: @leaderboard.bollywoodscore, cricketscore: @leaderboard.cricketscore, footballscore: @leaderboard.footballscore, hollywoodscore: @leaderboard.hollywoodscore, user_id: @leaderboard.user_id } }
