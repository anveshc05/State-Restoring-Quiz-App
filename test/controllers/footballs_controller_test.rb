...
class FootballsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create football" do
    assert_difference('Football.count') do
      post footballs_url, params: { football: { correctans: @football.correctans, opta: @football.opta, optb: @football.optb, optc: @football.optc, optd: @football.optd, question: @football.question } }
    end
  ...
  test "should update football" do
    patch football_url(@football), params: { football: { correctans: @football.correctans, opta: @football.opta, optb: @football.optb, optc: @football.optc, optd: @football.optd, question: @football.question } }
