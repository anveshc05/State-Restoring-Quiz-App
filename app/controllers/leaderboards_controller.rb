class LeaderboardsController < ApplicationController
  ...
  def index
    ...
    @sports = Leaderboard.order('maxfootscore+maxcricscore DESC')
    @movies = Leaderboard.order('maxbollyscore+maxhollyscore DESC')
  end
  ...
  private
    ...
    def leaderboard_params
      params.require(:leaderboard).permit(:user_id, :cricketscore, :footballscore, :bollywoodscore, :hollywoodscore)
    end
end
